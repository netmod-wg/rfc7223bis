...
such devices is outside the scope of this document.  See
^router-restricted^ and ^router-arbitrary^ for examples.
...
In most cases, the "name" of an "/interfaces-state/interface" entry is
...
!! include-figure ietf-interfaces.yang extract-to="ietf-interfaces@2014-05-08.yang"
...
!! include-figure ex-get-reply.load
